        ...
        var a = e("../common/PlayerInfo")
          ...
          , m = function(e) {
            ...
            t.prototype.createOneFruit = function(e) {//生成水果函数
                ...
                n.getComponent(cc.PhysicsCircleCollider).restitution=0.7,
        ...
        var a = e("./GameFunction")
          ...
          , p = function(e) {
            ...
            t.prototype.onTouchEnd = function(e) {
				...
				//随机水果
                this.scheduleOnce(function() {
                    i.default.GameUpdateCtrl && (0 == t.createFruitCount ? (a.default.Instance.createOneFruit(4),
                    t.createFruitCount++) : 1 == t.createFruitCount ? (a.default.Instance.createOneFruit(5),
                    t.createFruitCount++) : 2 == t.createFruitCount ? (a.default.Instance.createOneFruit(6),
                    ...
                    t.createFruitCount++) : t.createFruitCount > 5 && (a.default.Instance.createOneFruit(s.default.RandomInteger(4, 9)),
                    t.createFruitCount++))
                }, .5))
            }
            ,
